        ...
        <div className="grid grid-cols-12 pb-3">
            <div className="col-span-8 h-full">
                <swiper-container loop={true} style={{ height: "100%" }}>
                    <swiper-slide><img src={image1} className="w-full h-full object-cover" /></swiper-slide>
                    <swiper-slide ><img src={image2} className="w-full h-full object-cover" /></swiper-slide>
                    <swiper-slide><img src={image3} className="w-full h-full object-cover" /></swiper-slide>
                </swiper-container>
            </div>
